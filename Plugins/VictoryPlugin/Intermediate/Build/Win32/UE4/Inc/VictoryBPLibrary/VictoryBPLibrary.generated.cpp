...
static struct FScriptStruct_VictoryBPLibrary_StaticRegisterNativesFVictoryInput
{
	...
	void UVictoryBPFunctionLibrary::StaticRegisterNativesUVictoryBPFunctionLibrary()
	{
		...
		FNativeFunctionRegistrar::RegisterFunction(UVictoryBPFunctionLibrary::StaticClass(), "AddToStreamingLevels",(Native)&UVictoryBPFunctionLibrary::execAddToStreamingLevels);
		...
		FNativeFunctionRegistrar::RegisterFunction(UVictoryBPFunctionLibrary::StaticClass(), "GetLevelInstanceInfo",(Native)&UVictoryBPFunctionLibrary::execGetLevelInstanceInfo);
	...
	IMPLEMENT_CLASS(UVictoryBPFunctionLibrary, 3125236598);
	...
	UClass* Z_Construct_UClass_UVictoryBPFunctionLibrary()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UVictoryBPFunctionLibrary_VictoryLoadLevelInstance(), "VictoryLoadLevelInstance"); // 721010474
				...
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UVictoryBPFunctionLibrary_WidgetGetChildrenOfClass(), "WidgetGetChildrenOfClass"); // 3475922681
